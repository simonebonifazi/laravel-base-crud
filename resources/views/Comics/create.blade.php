...
<form action="{{ route('comics.store')}}" method="POST">
    ...
    <div class="mb-3">
        ...
        <input class="form-control  @error('title') is-invalid @enderror" type="text" id="title" name="title"
            placeholder="es. capitan america" value=" {{ old('title') }} ">
    </div>
    <!-- descizione -->
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input class="form-control @error('thumb') is-invalid @enderror" type="text" id="thumb" name="thumb"
            placeholder="Url della cover..." value=" {{ old('thumb') }}">
    </div>
    <!-- price -->
    <div class="mb-3">
        ...
        <input class="form-control @error('price') is-invalid @enderror" type="text" id="price" name="price"
            placeholder="scegli un prezzo ragionevole" value=" {{ old('price') }}">
    </div>
    ...
    <div class="mb-3">
        ...
        <input class="form-control @error('sale_date') is-invalid @enderror" type="text" id="sale_date" name="sale_date"
            placeholder="es.: 2023-08-22" value=" {{ old('sale_date') }}">
    </div>
    <!-- series -->
    <div class="mb-3">
        ...
        <input class="form-control @error('series') is-invalid @enderror" type="text" id="series" name="series"
            placeholder="es. aquaman, batman..." value=" {{ old('series') }}">
    </div>
    <!-- type -->
    <div class="mb-3">
        ...
        <input class="form-control @error('type') is-invalid @enderror" type="text" id="type" name="type"
            placeholder="es. graphic novel, comic book..." value=" {{ old('type')}}">
